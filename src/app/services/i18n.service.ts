...
const translations = {
  en: {
    ...
    // Footer
    footer: 'Developed by Miguel Rodríguez - 2026 - v1.4.0 - All rights reserved',
  },
  es: {
    dashboard: 'Panel',
    ...
    passwordMinLength: 'La contraseña debe tener al menos 6 caracteres',
     // Footer
     footer: 'Desarrollado por Miguel Rodríguez - 2026 - v1.4.0 - Todos los derechos reservados',
  }
};
